...
const LINKS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "AI Fortune Telling", href: "/services/ai-fortune-telling" },
      { name: "Banking AI", href: "/services/banking-ai" },
            ...
            <div className="lg:col-span-1">
              <div className="mb-8">
                ...
                <Typography 
                  ...
                  onPointerLeaveCapture={undefined}
                >
                  Transforming the future with intelligent AI solutions. We bridge the gap between 
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex-1 text-center">
                ...
                <Typography 
                  ...
                  onPointerLeaveCapture={undefined}
                >
                  © {CURRENT_YEAR} AI Studio - AI Solutions for a Better World. All rights reserved.
                </Typography>
              </div>
