    ...
    <section className="container mx-auto px-8 pb-12 pt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 order-1 lg:order-2">
            ...
            <Typography 
              ...
              onPointerLeaveCapture={undefined}
            >
              Founded in 2025, AI Studio emerged from a simple yet powerful vision: to
              harness artificial intelligence for the betterment of humanity. We are a
              team of passionate technologists, researchers, and innovators committed
              to developing AI solutions that create meaningful positive impact across
            ...
            <Typography 
              ...
              onPointerLeaveCapture={undefined}
            >
              Our approach combines cutting-edge research with practical applications,
              ensuring that every solution we develop serves a real-world purpose.
              From healthcare innovations to business automation, we're dedicated to
      ...
      <div className="mb-20 text-center">
        ...
        <Typography 
          ...
          onPointerLeaveCapture={undefined}
        >
          The brilliant minds behind AI Studio's innovative AI solutions.
        </Typography>
      </div>

      <div className="grid grid-cols-1 gap-16 md:grid-cols-2 lg:grid-cols-4 mb-16">
        {TEAM_MEMBERS.map(({ name, role, bio, img }, key) => {
